...
class UIHandler {
  ...
  updateNutritionState(state, content = null) {
    ...
    switch (state) {
      case 'loading':
        ...
        setElementOpacity(this.nutritionCard, this.config.nutritionCardOpacity.loading);
      ...
      case 'success':
        ...
        setElementOpacity(this.nutritionCard, this.config.nutritionCardOpacity.normal);
      ...
      case 'error':
        ...
        if (this.nutriFact) {
          setElementText(this.nutriFact, 'Tidak dapat menghasilkan informasi nutrisi saat ini.');
        }
        break;
    }
  }
  ...
  */
  showResults(prediction, nutrition) {
    ...
    this.resultCard.classList.remove('theme-green', 'theme-red', 'theme-yellow');
    this.resConfidence.classList.remove('text-green', 'text-red', 'text-yellow');
